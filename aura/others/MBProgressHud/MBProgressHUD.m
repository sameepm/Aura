...
- (void)layoutSubviews {
    ...
    if (nil != self.labelText) {
       ...
       // CGSize dims = [self.labelText sizeWithFont:self.labelFont];
        CGSize dims = [self.labelText sizeWithAttributes:@{ NSFontAttributeName: label.font }];
...
//            dims = [self.detailsLabelText sizeWithFont:self.detailsLabelFont];
            ...
            dims = [self.detailsLabelText sizeWithAttributes:@{ NSFontAttributeName:detailsLabelFont }];
